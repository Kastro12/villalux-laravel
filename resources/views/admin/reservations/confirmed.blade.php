    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{route('admin.reservations.confirmed')}}">
                <button class="btn btn-success" style="margin-right: 20px">Confirmed reservations</button>
            </a>
        </li>
        <li>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach($reserves as $reserve)
                        ...
                        <tr>
                            ...
                            <td>{{$reserve->paid}}€</td>
                            <td><button onclick="window.location.href='http://localhost/vl/public/admin/reservations/confirmed/edit/{{$reserve->id}}'" class="btn btn-dark">New</button></td>
