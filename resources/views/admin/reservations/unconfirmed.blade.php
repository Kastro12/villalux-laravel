    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{route('admin.reservations.unconfirmed')}}">
                <button class="btn btn-success" style="margin-right: 20px">Unconfirmed reservations</button>
            </a>
        </li>
        <li>
            ...
            <div class="col-sm-12"><br/>
                ...
                @foreach($reserves as $reserve)
                    <tr>
                        ...
                        <td>
                            <button onclick="window.location.href='http://localhost/vl/public/admin/reservations/confirmed/edit/{{$reserve->id}}'" class="btn btn-dark">Confirm</button>
                        </td>
