    ...
    <ol class="breadcrumb">
        <li>
            <a href="{{route('admin.payments')}}">
                <button class="btn btn-dark" style="margin-right: 20px"><b>Payments for this year</b></button>
            </a>
        </li>
        <li>
            <a href="{{route('admin.payments.past')}}">
                <button class="btn btn-light" style="margin-right: 20px"><b>Payments for the past year</b></button>
            </a>
        </li>
    </ol>
