  ...
  It has survived not only five centuries, but also the leap into electronic typesetting,
   ...
   Letraset sheets containing Lorem Ipsum passages, and more recently with desktop
    publishing software like Aldus PageMaker including versions of Lorem Ipsum.
     <br/><br/>It is a long established fact that a reader will be distracted by the readable
      ...
      purpose (injected humour and the like).<br/><br/>here are many variations of passages
...
<br/><br/>
<center><h2 style="color: #191970" id="a">About us</h2></center>
<br/>
<div class="container">
    <div class="row">
        <div class="col" id="text"  data-aos="flip-right" data-aos-duration="3000"> <center>
                <?php echo $tekst; ?>
            </center></div>
